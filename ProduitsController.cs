...
namespace AchatEnLigne.Controllers
{
    ...
    public class ProduitsController : Controller
    {
        ...
        public ProduitsController(AchatEnLigneContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Stock,Genre,Price,URL")] Produit produit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Stock,Genre,Price,URL")] Produit produit)
        {
            if (id != produit.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AchatEnLigneContext.Produit'  is null.");
            }
            var produit = await _context.Produit.FindAsync(id);
            if (produit != null)
            {
